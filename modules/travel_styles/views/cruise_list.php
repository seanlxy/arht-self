...
if( $travel_style_public_token && $total_cruises > 0)
{
...
$pgn_config['base_url']          = $travel_style_full_url;
...
$jsVars['data']['listAction']  = "action=fetch-travel-stlye-list&ts={$travel_style_public_token}";
