var app = {
    ...
    init:function(p)
    {
        ...
        $('#emergency_mode').change(function(){
            if($("#emergency_mode").prop('checked') == true)
            {
                var i = window.confirm("Are you sure, this will put your website into maintenance mode");
                if(i == true)
                {
                    $("#emergency_mode").prop('checked', true);
                }
                else
                {
                    $("#emergency_mode").prop('checked', false);
                }
            }
        });
