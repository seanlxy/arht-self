...
function edit_item()
{
    ...
    $sql = "SELECT e.`id`, e.`event_start_date`, e.`event_end_date`, e.`event_region`, e.`page_meta_data_id`,
...
$details_content = <<< HTML
    <table width="100%" border="0" cellspacing="0" cellpadding="8">
        ...
        <tr>
            <td width="130"><label for="name">Event Name:</label></td>
        ...
        <tr>
            ...
            <td width="130"><label for="url">Region:</label></td>
            <td><input name="event_region" type="text" id="url" value="$event_region" style="width:300px;" /></td>        
        </tr>
        <tr>
            <td width="130"><label for="url">Event Start Date:</label></td>
            <td><input name="event_start_date" type="text" id="event_start_date" value="$event_start_date" style="width:300px;" /></td>

            <td width="130"><label for="url">Event End Date:</label></td>
            <td><input name="event_end_date" type="text" id="event_end_date" value="$event_end_date" style="width:300px;" /></td>
    ...
    <script>
        ...
        $('#event_start_date').attr({autocomplete:'off', readonly:true}).datepicker({
            dateFormat:'yy-mm-dd'
        });

        $('#event_end_date').attr({autocomplete:'off', readonly:true}).datepicker({
            dateFormat:'yy-mm-dd'
        });
