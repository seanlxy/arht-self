...
function save_item (){
  ...
  //   }
	...
	$meta_data['gallery_id']           = sanitize_input('slideshow_id', FILTER_SANITIZE_NUMBER_INT);
	...
	// $page_data['publish_on']          = (validate_date($publish_datetime, 'd/m/Y H:i:s')) ? $publish_datetime : '';
	// $page_data['hide_on']             = (validate_date($hide_datetime, 'd/m/Y H:i:s')) ? $hide_datetime : '';
