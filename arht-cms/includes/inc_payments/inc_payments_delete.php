...
function delete_items()
{
	...
	if( !empty($id) )
	{
		...
		{
			$settings_content = '<div class="alert alert-danger" >
				...
				<div style="margin-top: 20px;">
					...
					<a href="'.$htmladmin.'?do='.$do.'" class="btn btn-default" style="font-size:14px; color:#000;margin-left:10px;"><i class="glyphicon glyphicon-arrow-left"></i> Cancel</a>
				</div>
			</div>';
		}
