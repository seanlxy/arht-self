...
function do_main(){
    ...
    $company_details['logo_path']     = "{$htmlroot}/graphics/logo.png";
    ...
    $payment_config = array(
        ...
        'requestEmailTmplPath' => "{$rootfull}/modules/payments/templates/email/request.tmpl",
        'emailTmplData' => $company_details
    );

    $obj_payment = new Payment($payment_config);
        ...
        if( !empty($rows) )
        {
            ...
            foreach ($rows as $index => $row)
            {
                ...
                <tr>
                    ...
                    <td width="80"><a href="$htmladmin/?do={$do}&action=resend&id={$id}&confirm=0"><strong>RESEND</strong></a></td>
...
HTML;
    ...
    <form action="{$htmladmin}/?do={$do}" method="post" style="margin:0px;" name="pageList">
        <table width="100%" class="bordered">
            <thead>
                <tr>
                    <th width="100" height="30">REQUEST ID</td>
