...
function view_trash()
{
   ...
   if($_POST['action'] === 'restore')
    ...
    function generate_item_list($parent_id = 0)
    {
        ...
        $sql = "SELECT d.`id`, pmd.`id` AS page_meta_id, pmd.`name`, pmd.`rank`,
        ...
        if( !empty($rows) )
        {
            ...
            foreach ($rows as $index => $row)
            {
                ...
                <tr>
                    ...
                    <td width="160" align="right">$deleted_date</td>
        ...
        <table width="100%" class="bordered">
            <thead>
                <tr>
                    ...
                    <th  width="160" align="left" style="font-size:12px;">Deleted On</th>
