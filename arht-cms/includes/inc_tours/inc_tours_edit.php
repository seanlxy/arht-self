...
function edit_item()
{
    ...
    $sql = "SELECT d.`id`, d.`latitude`, d.`longitude`, d.`formatted_address`, d.`page_meta_data_id`, pmd.`name`,
        pmd.`menu_label`, pmd.`heading`, pmd.`url`, pmd.`short_description`, pmd.`title`, pmd.`meta_description`,
        pmd.`og_title`, pmd.`og_image`, pmd.`slideshow_id`
        FROM `destination` d
    ...
    $main_subheading = 'Editing destination: '.$name;
...
$settings_content = <<< HTML
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="8">
        ...
        <tr>
            ...
            <td colspan="3"><input name="heading" type="text" id="heading" value="$heading" style="width:718px;" /></td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="short_description" id="short_description" style="width:718px;min-height:150px;">$short_description</textarea>
            </td>
        </tr>
...
$temp_array_menutab['Map']       = $map_content;
$temp_array_menutab['Slideshow'] = $slideshow_content;
