...
function do_main(){
    ...
    function generate_item_list($parent_id = 0)
    {
        ...
        $sql = "SELECT d.`id`, pmd.`id` AS page_meta_id, pmd.`name`, pmd.`status`, pmd.`rank`,
        ...
        if( !empty($rows) )
        {
            ...
            foreach ($rows as $index => $row)
            {
                ...
                <tr>
                    ...
                    <td width="160" align="right">$created_date</td>
                    <td width="160" align="right">$updated_date</td>
        ...
        <table width="100%" class="bordered">
            <thead>
                <tr>
                    ...
                    <th  width="160" align="left" style="font-size:12px;">Created on</th>
                    <th  width="160" align="left" style="font-size:12px;">Last Updated On</th>
